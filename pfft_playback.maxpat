...
,
		"classnamespace" : "box",
		"rect" : [ 1314.0, 782.0, 1212.0, 624.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 240.0, 268.0, 100.0, 22.0 ],
					"text" : "frameaccum~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 401.0, 100.0, 22.0 ],
					"text" : "fftout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 322.0, 100.0, 22.0 ],
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 71.0, 125.0, 73.5, 22.0 ],
					"text" : "*~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 240.0, 226.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 71.0, 226.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 418.5, 99.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.0, 46.0, 100.0, 22.0 ],
					"text" : "fftin~ 1 nofft"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.5, 92.0, 32.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 418.5, 46.0, 32.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
